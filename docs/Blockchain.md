...
We will use block `101247` as an example, which you can find it in the publicly available IDLL blockchain.
...
### IDLL Transaction Structure

We will use block `90010` as a transaction structure example, which you can find it in the publicly available IDLL blockchain.</br>
